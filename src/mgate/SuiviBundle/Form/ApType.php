...
class ApType extends AbstractType {
    ...
    public function buildForm(\Symfony\Component\Form\FormBuilderInterface $builder, array $options) {
        $builder->add('suiveur', 'genemu_jqueryselect2_entity', array('label' => 'Suiveur de projet',
                ...
                ->add('presentationProjet', 'textarea', array('label' => 'Présentation du projet', 'required' => false, 'attr'=>array("title"=>"La phrase commence par 'Dans le cadre de son activité professionnelle, \"NomDuClient\" ... '. Il faut la continuer en décrivant le projet. Le début de la phrase est déjà généré.", 'cols'=>'100%', 'rows'=>5)))
                ...
                ->add('competences', 'textarea', array('label' => 'Capacité des intervenants:', 'required' => false, 'attr'=>array("title"=>"La phrase commence par 'Les réalisateurs de cette étude devront donc être capables :'. Listez donc les capacités des intervenants sous la forme '- maitriser HTML/CSS', avec des sauts à la ligne.", 'cols'=>'100%', 'rows'=>5)));
    }
